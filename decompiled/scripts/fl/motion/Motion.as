   ...
   public class Motion extends MotionBase
   {
      ...
      public static function interpolateFilters(param1:Array, param2:Array, param3:Number) : Array
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            _loc8_ = interpolateFilter(_loc6_,_loc7_,param3);
            if(_loc8_)
            {
               _loc4_.push(_loc8_);
            }
      ...
      public static function interpolateFilter(param1:BitmapFilter, param2:BitmapFilter, param3:Number) : BitmapFilter
      {
         ...
         var _loc6_:XML = getTypeInfo(param1);
         var _loc7_:XMLList = _loc6_.accessor;
         for each(_loc8_ in _loc7_)
         {
            _loc9_ = _loc8_.@name.toString();
            _loc10_ = _loc8_.@type;
            if(_loc10_ == "Number" || _loc10_ == "int")
            {
      ...
      override public function getColorTransform(param1:int) : ColorTransform
      {
         ...
         {
            _loc7_ = this.getNextKeyframe(param1,"color") as Keyframe;
            if(!_loc7_ || !_loc7_.color)
            {
               _loc2_ = _loc4_;
            }
            else
      ...
      override public function getFilters(param1:Number) : Array
      {
         ...
         {
            _loc7_ = this.getNextKeyframe(param1,"filters") as Keyframe;
            if(!_loc7_ || !_loc7_.filters.length)
            {
               _loc2_ = _loc4_;
            }
            else
      ...
      override protected function findTweenedValue(param1:Number, param2:String, param3:KeyframeBase, param4:Number, param5:Number) : Number
      {
         ...
         var _loc6_:Keyframe = param3 as Keyframe;
         if(!_loc6_)
         {
            return NaN;
         }
         var _loc7_:ITween = _loc6_.getTween(param2) || _loc6_.getTween();
         if(!_loc7_ || !_loc6_.tweenScale && (param2 == Tweenables.SCALE_X || param2 == Tweenables.SCALE_Y) || _loc6_.rotateDirection == RotateDirection.NONE && (param2 == Tweenables.ROTATION || param2 == Tweenables.SKEW_X || param2 == Tweenables.SKEW_Y))
         {
            return param5;
         }
         ...
         var _loc9_:Keyframe = this.getNextKeyframe(param1,_loc8_) as Keyframe;
         if(!_loc9_ || _loc9_.blank)
         {
            return param5;
         }
